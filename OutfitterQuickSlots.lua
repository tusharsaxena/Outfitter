...
function Outfitter._FlyoutQuickSlots:GetLocationItemLink(pLocation)
	...
	if EquipmentManager_GetLocationData then
		...
		-- Disabled: the legacy EquipmentManager_UnpackLocation fallback.  It was
		-- removed from the game, and EquipmentManager_GetLocationData above has
		-- covered every supported client for several expansions.  Original in
		-- Deprecated.QuickSlots.UnpackLocation

		Outfitter:DeprecatedFeature("Legacy flyout location unpacking")
		return
	end
