...
function Outfitter._AboutView:Construct(pParent)
	...
	self.MaintainerText = self:CreateFontString(nil, "OVERLAY", "GameFontNormal")
	self.MaintainerText:SetPoint("TOP", self.AuthorText, "BOTTOM", 0, -4)
	self.MaintainerText:SetWidth(230)
	self.MaintainerText:SetJustifyH("CENTER")
	self.MaintainerText:SetText(Outfitter.cAboutMaintainer)

	self.CopyrightText = self:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
	self.CopyrightText:SetPoint("TOP", self.MaintainerText, "BOTTOM", 0, -10)
