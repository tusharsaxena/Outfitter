...
function Outfitter:GetBagItemInfo(bagIndex, slotIndex)
	...
	-- Gems are not captured: GetContainerItemGems was removed.  See
	-- Deprecated.Gems.ForBagSlot
...
function Outfitter:GetSlotIDItemInfo(slotID)
	...
	-- Gems are not captured: GetInventoryItemGems was removed.  See
	-- Deprecated.Gems.ForInventorySlot
	itemInfo.AzeriteCodes = self:GetAzeriteCodesForLocation(location)
