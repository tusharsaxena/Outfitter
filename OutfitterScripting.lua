...
if equip == equipped then
	...
	-- Battleground and arena outfits, one per map.  The generic Battleground and
	-- Arena presets above fire alongside these, so an outfit for a specific map
	-- layers over the general one -- see the ordering note on cZoneSpecialIDs

	{
		Name = Outfitter.cAVOutfit,
		ID = "AV",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_AV", Outfitter.cAVOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cABOutfit,
		ID = "AB",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_AB", Outfitter.cABOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cWSGOutfit,
		ID = "WSG",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_WSG", Outfitter.cWSGOutfitDescription, nil, true),
	},
	{
	...
	},
	{
		...
		ID = "TwinPeaks",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_TWINPEAKS", Outfitter.cTwinPeaksOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cGilneasOutfit,
		ID = "Gilneas",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_GILNEAS", Outfitter.cGilneasOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cWintergraspOutfit,
		ID = "Wintergrasp",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_WG", Outfitter.cWintergraspOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cSilvershardMinesOutfit,
		ID = "SilvershardMines",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_SILVERSHARD", Outfitter.cSilvershardMinesOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cTempleOfKotmoguOutfit,
		ID = "TempleOfKotmogu",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_KOTMOGU", Outfitter.cTempleOfKotmoguOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cDeepwindGorgeOutfit,
		ID = "DeepwindGorge",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_DEEPWIND", Outfitter.cDeepwindGorgeOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cSeethingShoreOutfit,
		ID = "SeethingShore",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_SEETHING", Outfitter.cSeethingShoreOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cDeephaulRavineOutfit,
		ID = "DeephaulRavine",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_DEEPHAUL", Outfitter.cDeephaulRavineOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cAshranOutfit,
		ID = "Ashran",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_ASHRAN", Outfitter.cAshranOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cLordaeronArenaOutfit,
		ID = "LordaeronArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_LORDAERON", Outfitter.cLordaeronArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cSewersOutfit,
		ID = "Sewers",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_SEWERS", Outfitter.cSewersOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cBladesEdgeArenaOutfit,
		ID = "BladesEdgeArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_BLADESEDGE", Outfitter.cBladesEdgeArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cNagrandArenaOutfit,
		ID = "NagrandArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_NAGRAND", Outfitter.cNagrandArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cTolVironArenaOutfit,
		ID = "TolVironArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_TOLVIRON", Outfitter.cTolVironArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cTigersPeakArenaOutfit,
		ID = "TigersPeakArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_TIGERSPEAK", Outfitter.cTigersPeakArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cBlackRookArenaOutfit,
		ID = "BlackRookArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_BLACKROOK", Outfitter.cBlackRookArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cAshamanesFallArenaOutfit,
		ID = "AshamanesFallArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_ASHAMANE", Outfitter.cAshamanesFallArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cHookPointArenaOutfit,
		ID = "HookPointArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_HOOKPOINT", Outfitter.cHookPointArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cMugambalaArenaOutfit,
		ID = "MugambalaArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_MUGAMBALA", Outfitter.cMugambalaArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cRobodromeArenaOutfit,
		ID = "RobodromeArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_ROBODROME", Outfitter.cRobodromeArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cEmpyreanDomainArenaOutfit,
		ID = "EmpyreanDomainArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_EMPYREAN", Outfitter.cEmpyreanDomainArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cMaldraxxusArenaOutfit,
		ID = "MaldraxxusArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_MALDRAXXUS", Outfitter.cMaldraxxusArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cEnigmaCrucibleArenaOutfit,
		ID = "EnigmaCrucibleArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_ENIGMA", Outfitter.cEnigmaCrucibleArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cNokhudonArenaOutfit,
		ID = "NokhudonArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_NOKHUDON", Outfitter.cNokhudonArenaOutfitDescription, nil, true),
	},
	{
		Name = Outfitter.cCageOfCarnageArenaOutfit,
		ID = "CageOfCarnageArena",
		Category = "PVP",
		Script = Outfitter:GenerateSmartUnequipScript("BATTLEGROUND_CAGEOFCARNAGE", Outfitter.cCageOfCarnageArenaOutfitDescription, nil, true),
	},
	{
		Name = "Spirit Regen",
		ID = "Spirit",
...
elseif didEquip then
	...
	},
	{
		...
		ID = "LOW_HEALTH",
		Category = "GENERAL",
		-- Disabled: the original read UnitHealth and UnitPower directly, which is an
		-- error once the client starts returning those as secret values.  The guarded
		-- version is Deprecated.LowHealthScriptBody -- it works, and putting it back is
		-- a matter of pasting it in here.  As with HAS_DEBUFF, Outfitter:GetScript
		-- reads this text out of Outfitter.PresetScripts every time the script runs, so
		-- replacing the body retires it for existing users too
		Script = Outfitter:GenerateScriptHeader("PLAYER_ENTERING_WORLD", Outfitter.cLowHealthDescription)..
[[
-- $SETTING Health="number"
-- $SETTING Mana="number"

-- This script no longer does anything: health and power come back as secret
-- values the addon isn't allowed to compare
]],
	},
	{
...
if equip == nil and didEquip then equip = false end
	...
	},
	{
		...
		ID = "HAS_DEBUFF",
		Category = "GENERAL",
		-- Disabled: UnitDebuff was removed from retail.  The preset stays registered
		-- so outfits already using it keep resolving, and because Outfitter:GetScript
		-- reads the text out of this table every time, replacing the body here
		-- disables it for existing users with no saved-variable migration.  The
		-- original body is Deprecated.HasDebuffScriptBody
		Script = Outfitter:GenerateScriptHeader("PLAYER_ENTERING_WORLD", Outfitter.cHasDebuffDescription)..
[[
...
-- This script no longer does anything: it was built on UnitDebuff, which the
-- game removed.  Reviving it means rewriting it against C_UnitAuras
]],
	},
	{
...
-- This script no longer does anything: it was built on GetMapNameByID, which the
...
-- This script no longer does anything: it was built on GetMapNameByID, which the
-- game removed, and on the Argent Tournament championing system.  The original
-- body is Deprecated.ChampioningScriptBodies.CHAMP
]],
    },
    {
...
-- This script no longer does anything: it was built on GetMapNameByID, which the
-- game removed, and on the Argent Tournament championing system.  The original
-- body is Deprecated.ChampioningScriptBodies.CHAMPCATACLYSM
]],
    },
	{
		Name = "Pet Battle",
