...
function Outfitter.OutfitBar.TextureSets.Spellbook:Activate()
	...
	-- Disabled: everything the spellbook half of this set was built on went away in
	-- 11.0.  MAX_SKILLLINE_TABS no longer exists, so both loops counted up to nil;
	-- GetSpellTabInfo became C_SpellBook.GetSpellBookSkillLineInfo; and the
	-- index-and-BOOKTYPE_SPELL form of GetSpellTexture is gone too.  The profession
	-- icons above still work and are still collected.  Original loops are in
	-- Deprecated.SpellbookIcons.Collect

	Outfitter:DeprecatedFeature("Spellbook icon set")
end
